...
const showCreateScreen = () => showScreenById('#create-section')

const showCreateSudokuScreen = () => showScreenById('#sudoku-section')


const showConnectScreen = async(filterTags) => {
...
const showGameScreen = () => showScreenById('#game-section');
...
const showGamesToConnect = async() => {
    fetch('/getgameslist')
        .then((response) => {
